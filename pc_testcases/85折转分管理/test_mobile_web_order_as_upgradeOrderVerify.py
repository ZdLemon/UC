...
class TestClass:
    ...
    @allure.severity(P1)
    @allure.title("升级单校验-成功路径: 85折转分订单退货时升级单校验检查")
    def test_mobile_web_order_as_upgradeOrderVerify(self):
        ...
        @allure.step("85折订单列表,获取total")
        def step_01_mobile_orderInfo_getClientOrderList():
        ...
        @allure.step("85折订单列表,获取订单")
        def step_02_mobile_orderInfo_getClientOrderList():
        ...
        step_01_mobile_orderInfo_getClientOrderList()
        step_02_mobile_orderInfo_getClientOrderList()
