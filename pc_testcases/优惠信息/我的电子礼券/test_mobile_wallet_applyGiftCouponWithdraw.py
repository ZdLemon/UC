...
@allure.story("/mobile/wallet/applyGiftCouponWithdraw")
class TestClass:
    """
    电子礼券申请提现
    ...
    @allure.severity(P1)
    @allure.title("电子礼券申请提现: 电子礼券申请提现主路径检查")
    def test_mobile_wallet_applyGiftCouponWithdraw(self):
        ...
        def step_mobile_wallet_applyGiftCouponWithdraw():
            ...
            data = {
                "giftCouponIdList":[getGiftCouponByMemberIdAndStatus["grantdtlId"]] # 电子礼券id集合
            }    
