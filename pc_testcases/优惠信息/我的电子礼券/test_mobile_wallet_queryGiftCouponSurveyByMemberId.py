...
@allure.story("/mobile/wallet/queryGiftCouponSurveyByMemberId")
class TestClass:
    """
    电子礼券调查配置项显示
    ...
    @allure.severity(P2)
    @allure.title("电子礼券提现配置查询: 电子礼券提现配置查询检查")
    def test_mobile_wallet_queryGiftCouponSurveyByMemberId(self):
