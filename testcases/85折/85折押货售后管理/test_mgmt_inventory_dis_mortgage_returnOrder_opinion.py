...
@allure.story("/mgmt/inventory/dis/mortgage/returnOrder/opinion")
class TestClass:
    """
    添加审批意见
    ...
    @allure.severity(P1)
    @allure.title("添加审批意见-成功路径: 押货退货审批时添加审批意见检查")
    def test_mgmt_inventory_dis_mortgage_returnOrder_opinion(self):
