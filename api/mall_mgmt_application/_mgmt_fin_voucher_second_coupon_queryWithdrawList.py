...
def _mgmt_fin_voucher_second_coupon_queryWithdrawList(data=data, access_token=access_token):
    """
    秒返券提现列表
    /mgmt/fin/voucher/second/coupon/queryWithdrawList
    """

    url = f"{BASE_URL}/mgmt/fin/voucher/second/coupon/queryWithdrawList"
