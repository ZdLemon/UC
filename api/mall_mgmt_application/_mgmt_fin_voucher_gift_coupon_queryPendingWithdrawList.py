...
def _mgmt_fin_voucher_gift_coupon_queryPendingWithdrawList(data=data, access_token=access_token):
    """
    电子礼券提现列表（待受理不分页）
    /mgmt/fin/voucher/gift/coupon/queryPendingWithdrawList
    """

    url = f"{BASE_URL}/mgmt/fin/voucher/gift/coupon/queryPendingWithdrawList"
