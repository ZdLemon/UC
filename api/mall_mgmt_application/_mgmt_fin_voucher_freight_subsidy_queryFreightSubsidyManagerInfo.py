...
def _mgmt_fin_voucher_freight_subsidy_queryFreightSubsidyManagerInfo(data=data, access_token=access_token):
    """
    运费补贴券管理查询接口(商城后台)
    /mgmt/fin/voucher/freight/subsidy/queryFreightSubsidyManagerInfo
    """

    url = f"{BASE_URL}/mgmt/fin/voucher/freight/subsidy/queryFreightSubsidyManagerInfo"
